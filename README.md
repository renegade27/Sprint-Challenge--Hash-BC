...
Constant time for adding to end and accessing, O(n) for adding to the front
* What is the worse case scenario if you try to extend the storage size of a dynamic array?
Making an array 2x the size of original and allocating all elements to new array
...
The node will either request the header or the entire block that was announced
